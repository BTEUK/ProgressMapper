...
public class ColourPicker
{
    ...
    public ColourPicker(int iMapID, Feature feature, Player player)
    {
        this.iMapID = iMapID;
    ...
    public Inventory getGUI()
    {
        ...
        TextColor textColor = TextColor.color(iRGBValue);

        //Creates the inventory
        Component component = Component.text("Edit colour", Style.style(TextColor.color(iRGBValue), TextDecoration.BOLD));
        ...
        Component default1 = Component.text("Dark Red", Style.style(TextColor.color(Integer.parseInt("cc1b15", 16)), TextDecoration.BOLD));
        Utils.insertItemIntoInventoryViaComponents(inventory, Material.RED_DYE, 1, 1, default1, new ArrayList<>());

        Component default2 = Component.text("Red", Style.style(TextColor.color(Integer.parseInt("e32c31", 16)), TextDecoration.BOLD));
        Utils.insertItemIntoInventoryViaComponents(inventory, Material.RED_DYE, 1, 2, default2, new ArrayList<>());

        Component default3 = Component.text("Dark Orange", Style.style(TextColor.color(Integer.parseInt("fb6033", 16)), TextDecoration.BOLD));
        Utils.insertItemIntoInventoryViaComponents(inventory, Material.ORANGE_DYE, 1, 3, default3, new ArrayList<>());

        Component default4 = Component.text("Orange", Style.style(TextColor.color(Integer.parseInt("f18729", 16)), TextDecoration.BOLD));
        Utils.insertItemIntoInventoryViaComponents(inventory, Material.ORANGE_DYE, 1, 4, default4, new ArrayList<>());

        Component default5 = Component.text("Light Orange", Style.style(TextColor.color(Integer.parseInt("f1ae29", 16)), TextDecoration.BOLD));
        Utils.insertItemIntoInventoryViaComponents(inventory, Material.ORANGE_DYE, 1, 5, default5, new ArrayList<>());

        Component default6 = Component.text("Yellow", Style.style(TextColor.color(Integer.parseInt("ffcc00", 16)), TextDecoration.BOLD));
        Utils.insertItemIntoInventoryViaComponents(inventory, Material.YELLOW_DYE, 1, 6, default6, new ArrayList<>());

        Component default7 = Component.text("Bright Yellow", Style.style(TextColor.color(Integer.parseInt("fff700", 16)), TextDecoration.BOLD));
        Utils.insertItemIntoInventoryViaComponents(inventory, Material.YELLOW_DYE, 1, 7, default7, new ArrayList<>());

        Component default8 = Component.text("Sick Green", Style.style(TextColor.color(Integer.parseInt("a0c514", 16)), TextDecoration.BOLD));
        Utils.insertItemIntoInventoryViaComponents(inventory, Material.LIME_DYE, 1, 8, default8, new ArrayList<>());

        Component default9 = Component.text("Complete Green", Style.style(TextColor.color(Integer.parseInt("3cc954", 16)), TextDecoration.BOLD));
        ...
        String szRedHex = HexFormat.of().withUpperCase().toHexDigits(textColor.red());
        //The red display
        ...
        String szGreenHex = HexFormat.of().withUpperCase().toHexDigits(textColor.green());
        //The green display
        ...
        String szBlueHex = HexFormat.of().withUpperCase().toHexDigits(textColor.blue());
        //The blue display
        ...
        //-----------------------------------------------------
        //Displays the colour
        Component colourDisplay = Component.text("This is the colour you've chosen", Style.style(textColor, TextDecoration.BOLD));
        Component loreLine1 = Component.text("#"+szRedHex+szGreenHex+szBlueHex, Style.style(textColor, TextDecoration.BOLD));
